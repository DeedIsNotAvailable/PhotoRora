...
if(NOT onnxruntime_DISABLE_ABSEIL)
  ...
  # Add the main abseil target
  list(APPEND onnxruntime_EXTERNAL_LIBRARIES abseil::abseil)
  include_directories(${absl_INCLUDE_DIRS})

  # Set ABSEIL_LIBS to include all commonly required abseil components
  # to prevent missing library errors
  set(ABSEIL_LIBS
    abseil::abseil
    absl::flags
...
if(NOT WIN32)
  find_package(atomic REQUIRED CONFIG)
  list(APPEND onnxruntime_EXTERNAL_LIBRARIES atomic::atomic)
endif()
